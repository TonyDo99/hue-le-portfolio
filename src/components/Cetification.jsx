        ...
        <div className="flex gap-5 justify-between flex-wrap group">
          {services.service_content.map((content, i) => (
            <a
              ...
              outline-none outline-offset-0 hover:!transition-all hover:!outline hover:!outline-2 hover:!outline-[#2CAAA0] group-hover:outline-none shadow-lg shadow-cyan-500/50"
            >
